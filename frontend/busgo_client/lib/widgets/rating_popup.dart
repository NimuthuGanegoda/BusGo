    ...
    try {
      ...
      final res = await http.post(
        ...
        body: jsonEncode({
          ...
          'stars':   3, // neutral default — ML will score the comment
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        // Clear the completed trip after 2 seconds
    ...
    children: [
      ...
      Row(children: [
        ...
        Expanded(child: Column(
          ...
          Text('Rate Your Trip', style: GoogleFonts.inter(
              fontSize: 17, fontWeight: FontWeight.w800,
              color: AppColors.primary)),
          Text('How was your journey?', style: GoogleFonts.inter(
        ...
        child: Row(children: [
          ...
          Expanded(child: Text(
            ...
            style: GoogleFonts.inter(fontSize: 11,
                color: AppColors.secondary, height: 1.4),
          )),
        ]),
      ),
      const SizedBox(height: 16),
      ...
      // Comment field
      Text('YOUR EXPERIENCE', style: GoogleFonts.inter(
      ...
      SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: _isSubmitting
              ...
              : Text('Submit Feedback', style: GoogleFonts.inter(
      ...
      Center(child: TextButton(
        ...
        child: Text('Skip for now', style: GoogleFonts.inter(
