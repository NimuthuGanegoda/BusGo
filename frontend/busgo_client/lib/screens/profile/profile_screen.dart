...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // FIX: load trip history so totalTrips count is real
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<UserProvider, TripProvider>(
        builder: (context, userProvider, tripProvider, _) {
          final user = userProvider.user;
          // FIX: use TripProvider.totalTrips instead of user?.totalTrips
          final tripCount = tripProvider.totalTrips;
          ...
          return SingleChildScrollView(child: Column(children: [
              ...
              child: SafeArea(bottom: false, child: Padding(
                ...
                child: Column(children: [
                  ...
                  Container(width: 100, height: 100,
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [_cyan, AppColors.primary],
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      // FIX: show real trip count from TripProvider
                      _buildStat('TRIPS', '$tripCount'),
                      _statDivider(),
            ...
            const Text('BUSGO v2.4.1 · © 2026 BUSGO Ltd.',
  ...
  Widget _buildToggle(String title, String subtitle, bool value,
      VoidCallback onChanged, {bool showBorder = true}) =>
      Container(
        ...
        child: Row(children: [
          ...
          GestureDetector(
            onTap: onChanged,
            child: Container(width: 44, height: 24,
              decoration: BoxDecoration(
                color: value
