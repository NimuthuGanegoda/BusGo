      ...
      body: Consumer<AuthProvider>(builder: (context, auth, _) {
        ...
        return SingleChildScrollView(child: Column(children: [
            ...
            child: SafeArea(bottom: false, child: Padding(
              ...
              child: Column(children: [
                CircleAvatar(radius: 40, backgroundColor: Colors.white,
                  child: Text(driver.initials, style: GoogleFonts.inter(
          ...
          Padding(padding: const EdgeInsets.all(20), child: Column(children: [
            Row(children: [
              Expanded(child: StatCard(label: 'Trips', value: '${driver.tripsCompleted}',
                  icon: Icons.route, color: AppColors.primary)),
              const SizedBox(width: 12),
              Expanded(child: StatCard(label: 'Rating', value: driver.ratingDisplay,
                  unit: '/5', icon: Icons.star_outline, color: AppColors.warning)),
            ]),
